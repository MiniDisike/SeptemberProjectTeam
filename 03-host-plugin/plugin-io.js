...
/**
 * 用户 R6（2026-09-17 逐字）：「角色说的话就这样显示了，AI不会把角色的话隐藏，
 *   然后通过自己来转述谁谁谁说了什么…这样的上下文干净。
 *   （我想要的就是这样，只是角色说话前加一个**名字与职称**的显示。）」
...
/**
 * ★ 角色发言（用户 R6，2026-09-17 逐字要的）：
 *   「角色说的话就这样显示了，AI不会把角色的话隐藏，然后通过自己来转述谁谁谁说了什么…
 *     这样的上下文干净。（我想要的就是这样，只是角色说话前加一个**名字与职称**的显示。）」
